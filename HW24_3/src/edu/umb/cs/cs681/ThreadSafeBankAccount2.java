...
public class ThreadSafeBankAccount2 {
	...
	private int sourceAccNo, destAccNo;
	...
	public static void main(String[] args) {
		System.out.println("This is Ordered	Locking");
	...
	public void transfer(ThreadSafeBankAccount2 source, ThreadSafeBankAccount2 destination, double amount)
		...
		try {
			...
			if (sourceAccNo < destAccNo) {
				System.out.println("Call when Source account number is less than Destination account number");
				source.lock.lock();
			...
			} else if (sourceAccNo > destAccNo) {

				
				System.out.println("Call when Source account number is greater than Destination account number");
				destination.lock.lock();
				source.lock.lock();
